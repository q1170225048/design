  ...
  <div class=" admin-content">
    <div class="daohang">
      <ul>
        ...
        <li>
          <button type="button" class="am-btn am-btn-default am-radius am-btn-xs">
          游戏管理<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a>
          </button>
        </li>
        <li>
          <button type="button" class="am-btn am-btn-default am-radius am-btn-xs">
          游戏列表<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a>
          </button>
        </li>
      </ul>
    </div>
