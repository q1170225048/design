...
//$('#myModal').modal('show');
    ...
    登录</li>
		...
		<div class="row">
            ...
            <div class="search-main-list" id="searchList"data-taptap-search-highlight-keyword="我" style="background: #fff;
    box-shadow: 0 2px 3px 0 rgba(0,0,0,.15);
    padding: 5px 20px;">
                                                                                                <div class="taptap-app-card" >
    <a href="https://www.taptap.com/app/59919" class="app-card-left">
        <img src="https://img.tapimg.com/market/lcs/ee944c549d7500386c5a4e70b69a2d57_360.png?imageView2/1/w/256/q/40/interlace/1/ignore-error/1" alt="你画我猜" title="你画我猜">
    </a>
    <div class="app-card-right">
        <a href="https://www.taptap.com/app/59919" class="card-right-title">
            <h4 data-taptap-search-highlight="target">你画我猜</h4>
                        <span class="title-end"></span>
        </a>
        <p class="card-right-author">
                            <a href="https://www.taptap.com/developer/20082" >北京我乐视界信息科技有限公司</a>
                        <span class="title-end"></span>
        </p>
                    <div class="card-right-rating">
                <span>9.2</span>
                <i class="background"></i>
                <i class="colored" style="width: 64.4px"></i>
            </div>
                            <span class="card-right-times">(124278人安装)</span>
                                <p class="card-tags">
                                                                        <a class="btn btn-xs btn-default "
                           href="https://www.taptap.com/hot/69"
                           >联机</a>
                                                                                <a class="btn btn-xs btn-default "
                           href="https://www.taptap.com/hot/11"
                           >益智</a>
                                                                                <a class="btn btn-xs btn-default "
                           href="https://www.taptap.com/hot/617"
                           >有毒</a>
                                                                                                                                </p>
    </div>
</div>
